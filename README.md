...
- **Side-by-Side Analytics**:
  - **Left**: Raw, uncompressed video playback stream.
  - **Right**: Real-time processed computer vision stream with sleek neon green (`#39FF14`) bounding boxes and persistent target ID overlays.
...
- **One-Click Download**: Direct download button to export the analyzed tracking video.
